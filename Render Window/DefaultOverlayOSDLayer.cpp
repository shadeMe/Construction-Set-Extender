		...
		void DefaultOverlayOSDLayer::Draw(RenderWindowOSD* OSD, ImGuiDX9* GUI)
		{
			...
			ImGui::Columns(2, "Cell and Cam Data", false);
			{
				if (CurrentCell)
				{
					...
					ImGui::Text("Current Cell:"); ImGui::SameLine(); ImGui::TextDisabled("  (?)"); ImGui::SetColumnWidth(0, FirstColumnWidth);
					...
					ImGui::Text("Camera:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
			...
			ImGui::Columns(2, "Selection Data", false);
			{
				if (_RENDERSEL->selectionCount)
				{
					...
					if (_RENDERSEL->selectionCount > 1)
					{
						...
						ImGui::NextColumn();
						ImGui::TextColored(ImColor(R, G, B), "Nominal Center:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
					...
					else
					{
						...
						{
							COLORTEXT_WITH_TOOLTIP(ImColor(R, G, B), "%s(%08X)%s", ((Selection->editorID.Size()) ? (Selection->editorID.c_str()) : ("")), Selection->formID, Selection->IsActive() ? "*" : ""); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							COLORTEXT_WITH_TOOLTIP(ImColor(R, G, B), "%s", TESForm::GetFormTypeIDLongName(Selection->baseForm->formType)); ImGui::NextColumn();

							ImGui::TextColored(ImColor(R, G, B), "Base Form:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							...
							ImGui::TextColored(ImColor(R, G, B), "Position:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							...
							ImGui::TextColored(ImColor(R, G, B), "Rotation:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							...
							ImGui::TextColored(ImColor(R, G, B), "Scale:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							COLORTEXT_WITH_TOOLTIP(ImColor(R, G, B), "%0.3f", Selection->scale); ImGui::NextColumn();

							ImGui::TextColored(ImColor(R, G, B), "Flags:");  ImGui::SameLine(); ImGui::TextDisabled("  (?)"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							if (ImGui::IsItemHovered())
							...
							if (xData)
							{
								...
								ImGui::TextColored(ImColor(R, G, B), "Parent:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
							...
							{
								ImGui::TextColored(ImColor(R, G, B), "Parent Cell:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
				...
				if (TESRenderWindow::SelectedPathGridPoints->Count() == 1)
				{
					...
					if (Point->linkedRef)
					{
						ImGui::TextColored(ImColor(R, G, B), "Linked Reference:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
			...
			ImGui::Columns(2, "Misc Data", false);
			{
				...
				if (GetProcessMemoryInfo(GetCurrentProcess(), (PROCESS_MEMORY_COUNTERS*)&MemCounter, sizeof(MemCounter)))
				{
					...
					ImGui::TextColored(ImColor(R, G, B), "RAM Usage:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
					ImGui::TextColored(ImColor(R, G, B), "%d MB  ", CurrentRAMCounter); ImGui::NextColumn();
				}

				ImGui::Text("FPS:"); ImGui::NextColumn(); ImGui::SetColumnWidth(0, FirstColumnWidth);
