...
#pragma endregion
	public:
		...
		typedef bool (* CommandHandler)(CSASDataElement* ArgArray, CSASDataElement* Result);
...
#define DEFINE_CSASCOMMAND(name, desc, noofparams, retntype)				CSASCommandInfo kCSASCommandInfo_ ##name (#name, 0, desc, noofparams, kParams_ ##name, retntype, CSASCmd_ ##name## _Execute)
#define DEFINE_CSASCOMMAND_ALIAS(name, alias, desc, noofparams, retntype)	CSASCommandInfo kCSASCommandInfo_ ##name (#name, alias, desc, noofparams, kParams_ ##name, retntype, CSASCmd_ ##name## _Execute)
#define DECLARE_CSASCOMMAND(commandname)									extern CSASCommandInfo kCSASCommandInfo_ ##commandname
#define BEGIN_CSASCOMMAND_HANDLER(commandname)								static bool CSASCmd_ ##commandname## _Execute(CSASDataElement* ArgArray, CSASDataElement* Result)
