...
void CSEINIManager::Initialize()
{
	...
	RegisterSetting(new SME::INI::INISetting(this, "LogCSWarnings", "Extender::Console", "1", "Log CS Warnings"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "LogAssertions", "Extender::Console", "1", "Log CS Assertions"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "Visible", "Extender::Console", "1", "Window visibility"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "UpdatePeriod", "Extender::Console", "2000", "Duration, in milliseconds, between window updates"), (CreateINI == false));
	...
	RegisterSetting(new SME::INI::INISetting(this, "LoadPlugin", "Extender::Startup", "0", "Load a plugin on CS startup"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "PluginName", "Extender::Startup", "", "Name of the plugin, with extension, that is to be loaded on startup"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "OpenScriptWindow", "Extender::Startup", "0", "Open an empty script editor window on startup"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "ScriptEditorID", "Extender::Startup", "", "EditorID of the script to be loaded on startup, should a script editor also be opened. An empty string results in a blank workspace"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "SetWorkspace", "Extender::Startup", "0", "Set the working directory to a custom path on startup"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "WorkspacePath", "Extender::Startup", "", "Path of the custom workspace directory"), (CreateINI == false));
	
	RegisterSetting(new SME::INI::INISetting(this, "SaveLoadedESPsAsMasters", "Extender::Plugins", "1", "Save loaded plugin files as the active plugin's master"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "PreventTimeStampChanges", "Extender::Plugins", "0", "Prevents the modifications to the timestamps of plugins being saved"), (CreateINI == false));
	...
	RegisterSetting(new SME::INI::INISetting(this, "ExecuteGlobalScripts", "Extender::CSAS", "1", "Executes global scripts in the background"), (CreateINI == false));
	...
	RegisterSetting(new SME::INI::INISetting(this, "Visible", "Extender::AuxViewport", "1", "Window visibility"), (CreateINI == false));

	RegisterSetting(new SME::INI::INISetting(this, "RenderWindowState", "Extender::Dialogs", "1", "Window visibility"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "ObjectWindowState", "Extender::Dialogs", "1", "Window visibility"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "CellWindowState", "Extender::Dialogs", "1", "Window visibility"), (CreateINI == false));

	RegisterSetting(new SME::INI::INISetting(this, "PartialTextureResolution", "Extender::LOD", "384", "Resolution of the generated partial LOD diffuse maps. Size of the full map = 16 * Res. Must be a power of 2 and b'ween 32 and 384"), (CreateINI == false));
	RegisterSetting(new SME::INI::INISetting(this, "DeletePartialsAfterGeneration", "Extender::LOD", "1", "Delete the partial LOD textures after the full map is generated"), (CreateINI == false));
