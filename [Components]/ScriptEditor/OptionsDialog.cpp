...
OptionsDialog::OptionsDialog()
{
	...
	SuppressRefCountForQuestScripts->Location = System::Drawing::Point(324, 91);
	SuppressRefCountForQuestScripts->Name = L"SuppressRefCountForQuestScripts";
	SuppressRefCountForQuestScripts->Size = System::Drawing::Size(144, 40);
	SuppressRefCountForQuestScripts->TabIndex = 3;
