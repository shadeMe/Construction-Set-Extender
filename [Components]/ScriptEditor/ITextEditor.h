...
interface class ITextEditor : public intellisense::IIntelliSenseInterfaceConsumer
{
	...
	event EventHandler^ ColumnChanged;			// raised when the current column changes
	...
	event EventHandler^ StaticTextDisplayChanged; // raised when static text display is enabled/disabled
	...
	bool InsertVariable(String^ VariableName, obScriptParsing::Variable::eDataType VariableType);
