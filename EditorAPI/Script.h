...
public:
	struct CompilerMessage
	{
		...
		CompilerMessage(UInt32 Line, const char* Message);

		bool IsWarning() const { return Type == MessageType::Warning; }
		bool IsError() const { return Type == MessageType::Error; }
		bool IsInfo() const { return Type == MessageType::Info; }
	};
	typedef std::vector<CompilerMessage> CompilerMessageArrayT;
	...
	static CompilerMessageArrayT		LastCompilationMessages;	// caches the compile errors generated by the last compile op
