...
public:
	...
	// methods
	TESFile*										LookupModByName(const char* PluginName);
};
...
public:
	...
	/*18*/ NiDirectionalLight*		niDirectionalLight;
	/*1C*/ BSFogProperty*			fogProperty;
	/*20*/ UInt32					unk20;					// cell grid x coordinate within current worldspace
	/*24*/ UInt32					unk24;					// grid y
