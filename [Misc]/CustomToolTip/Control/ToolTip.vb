...
''' Custom tooltip.
''' </summary>
<ProvideProperty("ToolTip", GetType(System.Windows.Forms.Control)), _
ProvideProperty("ToolTipTitle", GetType(Windows.Forms.Control)), _
ProvideProperty("ToolTipImage", GetType(Windows.Forms.Control))> _
...
#Region "Public Methods"
    ...
    <EditorAttribute(GetType(System.Drawing.Design.ImageEditor), _
        GetType(System.Drawing.Design.UITypeEditor)), DefaultValue(GetType(Image), "Nothing")> _
