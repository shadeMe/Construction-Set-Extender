...
#End Region
    ...
    Public Shared Function getContent(ByVal title As String, _
    ...
    Public Shared Function containsToolTip(ByVal title As String, _
    ...
    Public Shared Function measureSize(ByVal title As String, _
    ...
    Public Shared Sub drawToolTip(ByVal title As String, _
        ByVal text As String, ByVal img As Image, _
